...
Task~1 is evaluated with macro-averaged MAE (primary metric), RMSE, MAPE, and $R^2$ over nine divisions. Task~2 uses MAE and $R^2$ on OSI. Paired Wilcoxon signed-rank tests \cite{Wilcoxon1945SignedRank} on per-window macro demand MAE apply Bonferroni correction \cite{Dunn1961Bonferroni}; bootstrap 95\% confidence intervals \cite{Efron1993Bootstrap} and Cohen's $d$ \cite{Cohen1988StatisticalPower} supplement $p$-values.
